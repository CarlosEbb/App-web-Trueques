...
!(function (t, e) {
    ...
    return (function (t) {
                ...
                return (
                    ...
                    (t.prototype.encode = function (t) {
                        for (var e = "", n = 0; n < t.length - 2; n += 3) {
                            ...
                            (e += this._encodeByte((o >>> 18) & 63)),
                                (e += this._encodeByte((o >>> 12) & 63)),
                                (e += this._encodeByte((o >>> 6) & 63)),
                                (e += this._encodeByte((o >>> 0) & 63));
                        }
                        var r = t.length - n;
                        if (r > 0) {
                    ...
                    (t.prototype.decode = function (t) {
                        ...
                        for (
                            var e = this._getPaddingLength(t),
                                n = t.length - e,
                                o = new Uint8Array(this.maxDecodedLength(n)),
                                r = 0,
                                i = 0,
                                s = 0,
                                c = 0,
        ...
        function (t, e, n) {
            ...
            (e.encode = function (t) {
                for (
                    var e = new Uint8Array(r(t)), n = 0, o = 0;
                    o < t.length;
                    o++
                ) {
                    ...
                    for (var e = [], n = 0; n < t.length; n++) {
                        ...
                        if (128 & r) {
                            ...
                            if (r >= 65536) {
                                ...
                                (r -= 65536),
                                    e.push(
                                        String.fromCharCode(55296 | (r >> 10))
                                    ),
                                    (r = 56320 | (1023 & r));
                            }
                        }
        ...
        function (t, e, n) {
            ...
            var o,
                r = (function () {
                    ...
                    return (
                        (t.prototype.create = function (t) {
                            ...
                            return (
                                (this[e] = i),
                                { number: e, id: n, name: o, callback: i }
                            );
                        }),
                ...
                c = (function () {
                    ...
                    return (
                        (t.prototype.load = function (t, e, n) {
                            var o = this;
                            if (o.loading[t] && o.loading[t].length > 0)
                                o.loading[t].push(n);
                            else {
                                o.loading[t] = [n];
                ...
                _ = function (t, e, n) {
                    var o,
                        r = this;
                    for (var i in ((o = _e.createXHR()).open(
                        "POST",
            ...
            function H(t) {
                ...
                for (var o = 0; o < e.length; o++) {
                    var r = e[o];
                    for (var i in r)
                        r[i] && r[i].constructor && r[i].constructor === Object
                            ? (t[i] = H(t[i] || {}, r[i]))
                            : (t[i] = r[i]);
                }
                return t;
                ...
                Z = (function () {
                    ...
                    return (
                        (t.prototype.send = function (t) {
                            ...
                            o.insertBefore(e.script, o.firstChild),
                                e.errorScript &&
                                    o.insertBefore(
                                        e.errorScript,
                    ...
                    return (
                        (t.prototype.send = function (t) {
                            if (!this.request) {
                                ...
                                (this.request = _e.createScriptRequest(n)),
                                    this.request.send(t);
                            }
                        }),
                        (t.prototype.cleanup = function () {
                    ...
                    return (
                        ...
                        (t.prototype.add = function (t, e, n) {
                            ...
                            (this._callbacks[o] = this._callbacks[o] || []),
                                this._callbacks[o].push({ fn: e, context: n });
                        }),
            ...
            var ut = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.emit = function (t, e, n) {
                            for (
                                var o = 0;
                                o < this.global_callbacks.length;
                                o++
                            )
                                this.global_callbacks[o](t, e);
                            ...
                            if (
                                ...
                                for (o = 0; o < r.length; o++)
                                    r[o].fn.apply(r[o].context || window, i);
            ...
            var kt = bt,
                            ...
                            var i = this.transport.createConnection(t, e, n, o),
                                ...
                                a = function (t) {
                                    if (
                                        ...
                                        r.manager.reportDeath();
                                    else if (!t.wasClean && s) {
                                        var e = M.now() - s;
                                        e < 2 * r.maxPingDelay &&
                                            (r.manager.reportDeath(),
                                            (r.pingDelay = Math.max(
                                                e / 2,
                                                r.minPingDelay
                                            )));
                                    }
                ...
                xt = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            (o.id = e),
                            (o.transport = n),
                            (o.activityTimeout = n.activityTimeout),
                            o.bindListeners(),
                            o
                        );
                    }
                ...
                At = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.finish = function (t, e) {
                            this.callback(
                                H({ transport: this.transport, action: t }, e)
                            );
                        }),
                        t
                    );
                ...
                Rt = (function () {
                    function t(t, e) {
                        ...
                        if (void 0 === _e.getAuthorizers()[n])
                            throw (
                                "'" + n + "' is not a recognized auth transport"
                            );
                        (this.type = n),
                            (this.options = e),
                        ...
                        (t.prototype.composeQuery = function (t) {
                            ...
                            for (var n in this.authOptions.params)
                                e +=
                                    ...
                                    "=" +
                                    encodeURIComponent(
                                        this.authOptions.params[n]
                                    );
                            return e;
                        }),
                        (t.prototype.authorize = function (e, n) {
                            (t.authorizers =
                                t.authorizers || _e.getAuthorizers()),
                                t.authorizers[this.type].call(this, _e, e, n);
                        }),
                        t
                    );
                })(),
                ...
                It = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            ...
                            (o.pusher = n),
                            (o.subscribed = !1),
                            (o.subscriptionPending = !1),
                            (o.subscriptionCancelled = !1),
                            o
                        );
                    }
                    return (
                ...
                Wt = (function (t) {
                    function e(e, n) {
                        ...
                        (o.state = "initialized"),
                            ...
                            (o.connectionCallbacks = o.buildConnectionCallbacks(
                                o.errorCallbacks
                            )),
                            (o.handshakeCallbacks = o.buildHandshakeCallbacks(
                                o.errorCallbacks
                            ));
                        var r = _e.getNetwork();
                        return (
                            r.bind("online", function () {
                                o.timeline.info({ netinfo: "online" }),
                                    ("connecting" !== o.state &&
                                        "unavailable" !== o.state) ||
                                        o.retryIn(0);
                            }),
                            r.bind("offline", function () {
                                o.timeline.info({ netinfo: "offline" }),
                    ...
                    return (
                            ...
                            var t = this,
                                e = function (n, o) {
                                    n
                                        ...
                                        : (t.abortConnecting(),
                                          t.handshakeCallbacks[o.action](o));
                                };
                        ...
                        (e.prototype.updateState = function (t, e) {
                            ...
                            if (((this.state = t), n !== t)) {
                                var o = t;
                                "connected" === o &&
                                    (o += " with new socket ID " + e.socket_id),
                                ...
                                this.channels[t] ||
                                    (this.channels[t] = (function (t, e) {
                                        ...
                                        return 0 === t.indexOf("private-")
                                            ? Qt.createPrivateChannel(t, e)
                                            : 0 === t.indexOf("presence-")
                                            ? Qt.createPresenceChannel(t, e)
                                            : Qt.createChannel(t, e);
                                    })(t, e)),
                                this.channels[t]
                            );
                        }),
                    ...
                    return (
                        !(
                            ...
                            ? ((r = Object.assign(
                              ...
                              (s = new Ce(e, o, i ? i.getAssistant(c) : c, r)))
                            : (s = Ee),
                        s
                    );
                },
            ...
            var De = (function () {
                    function t(e, n) {
                        ...
                        "disableStats" in n &&
                            ...
                            (this.config =
                                ((r = {
                                    activityTimeout:
                                        ...
                                        s.activityTimeout,
                                    authEndpoint:
                                        o.authEndpoint || s.authEndpoint,
                                    authTransport:
                                        o.authTransport || s.authTransport,
                                ...
                                "authorizer" in o &&
                                    (r.authorizer = o.authorizer),
                                "disabledTransports" in o &&
                                    (r.disabledTransports =
                                        o.disabledTransports),
                                "enabledTransports" in o &&
                                    (r.enabledTransports = o.enabledTransports),
                                "ignoreNullOrigin" in o &&
                                    (r.ignoreNullOrigin = o.ignoreNullOrigin),
                                "timelineParams" in o &&
                                    (r.timelineParams = o.timelineParams),
                            ...
                            (this.timeline = new ke(this.key, this.sessionID, {
                        ...
                        (this.connection = Qt.createConnectionManager(
                            ...
                            this.connection.bind("connected", function () {
                                i.subscribeAll(),
                                    i.timelineSender &&
                                        i.timelineSender.send(
                                            i.connection.isUsingTLS()
                                        );
                            }),
                    ...
                    return (
                        ...
                        (t.prototype.connect = function () {
                            if (
                                ...
                                this.timelineSenderTimer = new N(
                                    6e4,
                                    function () {
                                        e.send(t);
                                    }
