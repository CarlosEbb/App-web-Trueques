...
class SubCategoriaController extends Controller
{
    ...
    {
        $categorias = SubCategoria::create($request->all());
    ...
    public function show($id)
    {
        ...
        return view('admin.categorias.listarSubCategoria')->with(compact('categorias'));
    }
    ...
    {
        $productos = SubCategoria::find($id)->delete();
