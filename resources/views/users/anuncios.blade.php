                                ...
                                {!! Form::model($producto, ['route' => ['productos.update', $producto->id], 'method' => 'PUT', 'files' => true]) !!}
                                  <div class="modal-body">
                                    <div class="form-row">
                                      ...
                                      @if($producto->categoria1 != null)<label for="" class="mb-0"><b>Categoria 1:</b> {{\App\Models\Categoria::find($producto->categoria1)->nombre}}</label>@endif
                                        <div class="d-flex justify-content-between mb-2">
                                        @if($producto->subCategoria1 != null)<label for="" class="small"><b style="color: #737373; font-weight: 300;">Sub Categoria 1:</b> {{\App\Models\SubCategoria::find($producto->subCategoria1)->nombre}}</label>@endif
