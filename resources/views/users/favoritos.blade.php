        ...
        <ul class="list-unstyled">
          <li class="media media-style">
            ...
            <div class="media-body">
              <h5 class="mt-0 mb-0 d-inline-block" style="width: 90%;">List-based media object</h5>
              ...
              <a class="btn-rounded btn-rounded-delete tooltips d-inline-block" href="#">
              ...
              <h6 class="mt-0 mb-0">1.500.000 $</h6>
              <p class="text-muted mb-0">
                <small>Publicado por:
                  <a href="#" target="_blank" rel="noopener noreferrer">Miguel Perez</a></small>
              </p>
            </div>
          </li>
        </ul>
