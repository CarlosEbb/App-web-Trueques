          ...
          @forelse(App\Models\ProductoFavorito::where('user_id', Auth::user()->id)->get() as $favorito)
            <li class="media media-style">
              ...
              <div class="media-body">
                ...
                <a class="btn-rounded btn-rounded-chat tooltips d-inline-block" @Auth href="{{route('chat')}}?p={{$favorito->id}}&v={{$favorito->user_id}}&c={{Auth::user()->id}}" @else href="{{route('login')}}" @endauth>
