    ...
    <form name="formulariobusqueda" action="{{route('busqueda')}}" method="GET" class="d-none d-md-none d-lg-block" style="width: 60%;">@csrf
      ...
      <div class="form-row align-items-center">
        ...
        <div class="col-md-8 d-flex">
          <input type="text" class="form-control input-search" placeholder="Buscar Productos" name="busqueda" @isset($_GET['busqueda']) value="{{$_GET['busqueda']}}" @endisset>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu menu menu-categorias mt-2 px-1" aria-labelledby="dropdownMenuLink">
        <div class="content-categorias">
          <a href="#" class="d-block d-md-none dropdown-toggle"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1.5em" height="1.5em" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8l8 8l1.41-1.41L7.83 13H20v-2z" fill="#25405f"/><rect x="0" y="0" width="24" height="24" fill="rgba(0, 0, 0, 0)" /></svg></a>
