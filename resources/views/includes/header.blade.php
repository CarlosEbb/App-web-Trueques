    ...
    <div class="container">
      ...
      <form action="" class="d-none d-md-none d-lg-block" style="width: 57%;">
        <div class="form-row align-items-center">
          <div class="col-md-4">
            <select class="form-control p-0 select-city">
      ...
      @guest
        <div class="d-flex justify-content-end content-menu-logaut">
          ...
          <div class="content-item-menu d-block d-md-block d-lg-none">
            <a class="my-auto btn-rounded btn-rounded-light btn-rounded-light-hover mx-1 tooltips btn-menu-buscar" href="#">
