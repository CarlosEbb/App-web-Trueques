      ...
      <div class="col-12 col-md-8 col-lg-5 p-0 p-md-1">
        <form method="POST" action="{{ route('login') }}">@csrf
          <div class="card p-4 card-border-radius border-0 card-login-register">
            ...
            <button type="submit" class="py-2 btn-rounded bg-primary mt-2 text-white btn-primary-dark">
            ...
            <button type="submit" class="btn-rounded bg-light mt-2 btn-primary-dark">
