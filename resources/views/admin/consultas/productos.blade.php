            ...
            @foreach($productos as $producto)
                <tr class="py-0">
                    <tr>
                        ...
                        <td class="text-table">@if($producto->subCategoria1 != null) @if(\App\Models\SubCategoria::find($producto->subCategoria1)->nombre == 'Otros') {{\App\Models\Categoria::find($producto->categoria1)->nombre}} @else {{\App\Models\SubCategoria::find($producto->subCategoria1)->nombre}} @endif @endif</td>
                        ...
                        <td class="text-table">@if($producto->subCategoria2 != null) @if(\App\Models\SubCategoria::find($producto->subCategoria2)->nombre == 'Otros') {{\App\Models\Categoria::find($producto->categoria2)->nombre}} @else {{\App\Models\SubCategoria::find($producto->subCategoria2)->nombre}} @endif @endif</td>
                        ...
                        <td class="text-table">@if($producto->subCategoria3 != null) @if(\App\Models\SubCategoria::find($producto->subCategoria3)->nombre == 'Otros') {{\App\Models\Categoria::find($producto->categoria3)->nombre}} @else {{\App\Models\SubCategoria::find($producto->subCategoria3)->nombre}} @endif @endif</td>
